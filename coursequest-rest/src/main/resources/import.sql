...
insert into USER_COURSE_TBL (COURSE_ID, USER_ID) values(6,1);
insert into USER_COURSE_TBL (COURSE_ID, USER_ID) values(7,1);
insert into USER_COURSE_TBL (COURSE_ID, USER_ID) values(7,2);
